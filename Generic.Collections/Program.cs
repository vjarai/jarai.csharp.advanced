...
namespace Jarai.CSharp.Generic.Collections
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            _myQueue.Enqueue(10);
            _myQueue.Enqueue(50);
            Console.WriteLine(_myQueue.Dequeue());  // 10
            Console.WriteLine(_myQueue.Dequeue());  // 50

            // Stacks geben Elemente in umgekehrter Reihenfolge wieder aus (FILO)
            _myStack = new Stack<int>();
            _myStack.Push(10);
            _myStack.Push(50);
            Console.WriteLine(_myStack.Pop()); // 50
            Console.WriteLine(_myStack.Pop()); // 10
            ...
            _myDictionary.Add("ok", "ok");

            Console.WriteLine(_myDictionary["Gut"]); // Good
        }
    }
}