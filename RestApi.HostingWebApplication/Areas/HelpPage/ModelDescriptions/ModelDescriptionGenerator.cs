    ...
    public class ModelDescriptionGenerator
    {
        ...
        public ModelDescriptionGenerator(HttpConfiguration config)
        {
            ...
            _documentationProvider =
                new Lazy<IModelDocumentationProvider>(() => config.Services.GetDocumentationProvider() as IModelDocumentationProvider);
        ...
        public ModelDescription GetOrCreateModelDescription(Type modelType)
        {
            ...
            if (typeof(IEnumerable).IsAssignableFrom(modelType)) return GenerateCollectionModelDescription(modelType, typeof(object));
        ...
        private ModelDescription GenerateComplexTypeModelDescription(Type modelType)
        {
            ...
            foreach (var property in properties)
                if (ShouldDisplayMember(property, hasDataContractAttribute))
                {
                    ...
                    if (DocumentationProvider != null) propertyModel.Documentation = DocumentationProvider.GetDocumentation(property);
            ...
            foreach (var field in fields)
                if (ShouldDisplayMember(field, hasDataContractAttribute))
                {
                    ...
                    if (DocumentationProvider != null) propertyModel.Documentation = DocumentationProvider.GetDocumentation(field);
